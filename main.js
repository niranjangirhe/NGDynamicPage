...
function Get(yourUrl) {
    ...
    console.log("hi",jsonobj.title1,jsonobj.title2,jsonobj.title3,jsonobj.para1,jsonobj.para2,jsonobj.para3,jsonobj.heading1,jsonobj.subtitle2,jsonobj.subtitle3)
    btn1=jsonobj.btn1
    btn2=jsonobj.btn2
    btn3=jsonobj.btn3
}
